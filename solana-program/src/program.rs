...
use crate::{
    account_info::AccountInfo, entrypoint::Result<..., ProgramError>, instruction::Instruction, pubkey::Pubkey,
...
///     entrypoint,
///     entrypoint::Result<..., ProgramError>,
///     program::invoke,
///     pubkey::Pubkey,
///     system_instruction,
///     system_program,
...
/// }
/// ```
pub fn invoke(instruction: &Instruction, account_infos: &[AccountInfo]) -> Result<..., ProgramError> {
...
/// behavior.
pub fn invoke_unchecked(instruction: &Instruction, account_infos: &[AccountInfo]) -> Result<..., ProgramError> {
