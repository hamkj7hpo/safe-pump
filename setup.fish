...
if test -f $anchor_spl_toml
    ...
    set anchor_rev (git rev-parse HEAD)
    cd -
else
...
if test -f $token_2022_toml
    ...
    sed -i '/\[dependencies\]/a solana-zk-sdk = { git = "https://github.com/hamkj7hpo/zk-elgamal-proof.git", rev = "'$zk_rev'", package = "solana-zk-sdk" }' $token_2022_toml
    sed -i '/\[dependencies\]/a solana-program = { git = "https://github.com/hamkj7hpo/solana.git", rev = "'$solana_rev'", package = "solana-program" }' $token_2022_toml
    sed -i '/\[dependencies\]/a zeroize = "1.3.0"' $token_2022_toml
    cd $tmp_dir/token-2022
    git add Cargo.toml
    git commit -m "Update solana-zk-sdk, solana-program, and zeroize to safe-pump-compat revs" || true
    git push origin $branch
    if test $status -ne 0
...
if test -f $assoc_token_toml
    ...
    sed -i '/\[dependencies\]/a solana-program = { git = "https://github.com/hamkj7hpo/solana.git", rev = "'$solana_rev'", package = "solana-program" }' $assoc_token_toml
    ...
    set assoc_rev (git rev-parse HEAD)
    cd -
else
...
if test -f $spl_discriminator_toml
    ...
    set library_rev (git rev-parse HEAD)
    cd -
else
...
if test -f $spl_tlv_toml
    ...
    set tlv_rev (git rev-parse HEAD)
    cd -
else
...
if test -f $token_group_toml
    echo "Patching $token_group_toml for solana-program and spl-pod..."
    sed -i '/solana-program/d' $token_group_toml
    sed -i '/spl-pod/d' $token_group_toml
    sed -i '/\[dependencies\]/a solana-program = { git = "https://github.com/hamkj7hpo/solana.git", rev = "'$solana_rev'", package = "solana-program" }' $token_group_toml
    sed -i '/\[dependencies\]/a spl-pod = { git = "https://github.com/hamkj7hpo/spl-pod.git", rev = "'$pod_rev'", package = "spl-pod", default-features = false }' $token_group_toml
    ...
    set group_rev (git rev-parse HEAD)
    cd -
else
...
if test -f $token_metadata_toml
    ...
    set metadata_rev (git rev-parse HEAD)
    cd -
else
...
if test -f $transfer_hook_toml
    ...
    sed -i '/\[dependencies\]/a solana-program = { git = "https://github.com/hamkj7hpo/solana.git", rev = "'$solana_rev'", package = "solana-program" }' $transfer_hook_toml
    ...
    set transfer_rev (git rev-parse HEAD)
    cd -
else
...
if test -f $memo_toml
    ...
    sed -i '/\[dependencies\]/a solana-program = { git = "https://github.com/hamkj7hpo/solana.git", rev = "'$solana_rev'", package = "solana-program" }' $memo_toml
    cd $tmp_dir/memo
    git add Cargo.toml
    git commit -m "Update solana-program to safe-pump-compat rev" || true
    git push origin $branch
    ...
    set memo_rev (git rev-parse HEAD)
    cd -
else
...
if test -f $project_toml
    ...
    sed -i '/\[dependencies\]/a spl-token-group-interface = { git = "https://github.com/hamkj7hpo/token-group.git", rev = "'$group_rev'", package = "spl-token-group-interface" }' $project_toml
    sed -i '/\[dependencies\]/a spl-token-metadata-interface = { git = "https://github.com/hamkj7hpo/token-metadata.git", rev = "'$metadata_rev'", package = "spl-token-metadata-interface" }' $project_toml
    sed -i '/\[dependencies\]/a spl-transfer-hook-interface = { git = "https://github.com/hamkj7hpo/transfer-hook.git", rev = "'$transfer_rev'", package = "spl-transfer-hook-interface" }' $project_toml
    sed -i '/\[dependencies\]/a spl-type-length-value = { git = "https://github.com/hamkj7hpo/spl-type-length-value.git", rev = "'$tlv_rev'", package = "spl-type-length-value" }' $project_toml
    ...
    sed -i '/\[dependencies\]/a anchor-spl = { git = "https://github.com/hamkj7hpo/anchor.git", rev = "'$anchor_rev'", default-features = false }' $project_toml
    sed -i '/\[dependencies\]/a spl-pod = { git = "https://github.com/hamkj7hpo/spl-pod.git", rev = "'$pod_rev'", default-features = false }' $project_toml
    sed -i '/\[dependencies\]/a solana-zk-sdk = { git = "https://github.com/hamkj7hpo/zk-elgamal-proof.git", rev = "'$zk_rev'", package = "solana-zk-sdk" }' $project_toml
    sed -i '/\[dependencies\]/a spl-token-2022 = { git = "https://github.com/hamkj7hpo/token-2022.git", rev = "'$token_rev'", package = "spl-token-2022", default-features = false }' $project_toml
    sed -i '/\[dependencies\]/a spl-associated-token-account = { git = "https://github.com/hamkj7hpo/associated-token-account.git", rev = "'$assoc_rev'", default-features = false }' $project_toml
