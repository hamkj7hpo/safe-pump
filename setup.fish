...
sed -i 's|aes-gcm-siv =.*|aes-gcm-siv = { git = "https://github.com/hamkj7hpo/aes-gcm-siv.git", branch = "safe-pump-compat" }|' Cargo.toml
sed -i 's|base64 =.*|base64 = { git = "https://github.com/hamkj7hpo/base64.git", branch = "safe-pump-compat" }|' Cargo.toml
sed -i 's|bincode =.*|bincode = { git = "https://github.com/hamkj7hpo/bincode.git", branch = "safe-pump-compat" }|' Cargo.toml
sed -i 's|borsh =.*|borsh = { git = "https://github.com/hamkj7hpo/borsh.git", branch = "safe-pump-compat" }|' Cargo.toml
sed -i 's|bytemuck =.*|bytemuck = { git = "https://github.com/hamkj7hpo/bytemuck.git", branch = "safe-pump-compat", features = ["derive"] }|' Cargo.toml
sed -i 's|getrandom =.*|getrandom = { git = "https://github.com/hamkj7hpo/getrandom.git", branch = "safe-pump-compat", features = ["custom"] }|' Cargo.toml
sed -i 's|lazy_static =.*|lazy_static = { git = "https://github.com/hamkj7hpo/lazy_static.git", branch = "safe-pump-compat" }|' Cargo.toml
sed -i 's|light-poseidon =.*|light-poseidon = { git = "https://github.com/hamkj7hpo/light-poseidon.git", branch = "safe-pump-compat" }|' Cargo.toml
sed -i 's|num =.*|num = { git = "https://github.com/hamkj7hpo/num.git", branch = "safe-pump-compat" }|' Cargo.toml
sed -i 's|num-derive =.*|num-derive = { git = "https://github.com/hamkj7hpo/num-derive.git", branch = "safe-pump-compat" }|' Cargo.toml
sed -i 's|num-traits =.*|num-traits = { git = "https://github.com/hamkj7hpo/num-traits.git", branch = "safe-pump-compat" }|' Cargo.toml
sed -i 's|rand =.*|rand = { git = "https://github.com/hamkj7hpo/rand.git", branch = "safe-pump-compat" }|' Cargo.toml
sed -i 's|serde =.*|serde = { git = "https://github.com/hamkj7hpo/serde.git", branch = "safe-pump-compat" }|' Cargo.toml
sed -i 's|sha3 =.*|sha3 = { git = "https://github.com/hamkj7hpo/sha3.git", branch = "safe-pump-compat" }|' Cargo.toml
sed -i 's|thiserror =.*|thiserror = { git = "https://github.com/hamkj7hpo/thiserror.git", branch = "safe-pump-compat" }|' Cargo.toml
sed -i 's|tiny-bip39 =.*|tiny-bip39 = { git = "https://github.com/hamkj7hpo/tiny-bip39.git", branch = "safe-pump-compat" }|' Cargo.toml
git add Cargo.toml
...
sed -i 's|base64 =.*|base64 = { git = "https://github.com/hamkj7hpo/base64.git", branch = "safe-pump-compat" }|' Cargo.toml
sed -i 's|bytemuck =.*|bytemuck = { git = "https://github.com/hamkj7hpo/bytemuck.git", branch = "safe-pump-compat" }|' Cargo.toml
sed -i 's|bytemuck_derive =.*|bytemuck_derive = { git = "https://github.com/hamkj7hpo/bytemuck_derive.git", branch = "safe-pump-compat" }|' Cargo.toml
sed -i 's|num-derive =.*|num-derive = { git = "https://github.com/hamkj7hpo/num-derive.git", branch = "safe-pump-compat" }|' Cargo.toml
sed -i 's|num-traits =.*|num-traits = { git = "https://github.com/hamkj7hpo/num-traits.git", branch = "safe-pump-compat" }|' Cargo.toml
...
sed -i 's|bincode =.*|bincode = { git = "https://github.com/hamkj7hpo/bincode.git", branch = "safe-pump-compat" }|' Cargo.toml
sed -i 's|curve25519-dalek =.*|curve25519-dalek = { git = "https://github.com/hamkj7hpo/curve25519-dalek.git", branch = "safe-pump-compat-v2", features = ["serde"] }|' Cargo.toml
sed -i 's|itertools =.*|itertools = { git = "https://github.com/hamkj7hpo/itertools.git", branch = "safe-pump-compat" }|' Cargo.toml
sed -i 's|merlin =.*|merlin = { git = "https://github.com/hamkj7hpo/merlin.git", branch = "safe-pump-compat" }|' Cargo.toml
sed -i 's|rand =.*|rand = { git = "https://github.com/hamkj7hpo/rand.git", branch = "safe-pump-compat" }|' Cargo.toml
sed -i 's|serde =.*|serde = { git = "https://github.com/hamkj7hpo/serde.git", branch = "safe-pump-compat" }|' Cargo.toml
sed -i 's|serde_derive =.*|serde_derive = { git = "https://github.com/hamkj7hpo/serde_derive.git", branch = "safe-pump-compat" }|' Cargo.toml
sed -i 's|serde_json =.*|serde_json = { git = "https://github.com/hamkj7hpo/serde_json.git", branch = "safe-pump-compat" }|' Cargo.toml
sed -i 's|sha3 =.*|sha3 = { git = "https://github.com/hamkj7hpo/sha3.git", branch = "safe-pump-compat" }|' Cargo.toml
...
sed -i 's|subtle =.*|subtle = { git = "https://github.com/hamkj7hpo/subtle.git", branch = "safe-pump-compat" }|' Cargo.toml
...
sed -i 's|getrandom =.*|getrandom = { git = "https://github.com/hamkj7hpo/getrandom.git", branch = "safe-pump-compat", features = ["js"] }|' Cargo.toml
sed -i 's|js-sys =.*|js-sys = { git = "https://github.com/hamkj7hpo/js-sys.git", branch = "safe-pump-compat" }|' Cargo.toml
sed -i 's|wasm-bindgen =.*|wasm-bindgen = { git = "https://github.com/hamkj7hpo/wasm-bindgen.git", branch = "safe-pump-compat" }|' Cargo.toml
